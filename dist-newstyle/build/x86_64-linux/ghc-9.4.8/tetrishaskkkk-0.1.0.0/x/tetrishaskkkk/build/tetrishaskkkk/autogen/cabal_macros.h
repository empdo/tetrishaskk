...
/* package tetrishaskkkk-0.1.0.0 */
#ifndef VERSION_tetrishaskkkk
#define VERSION_tetrishaskkkk "0.1.0.0"
#endif /* VERSION_tetrishaskkkk */
#ifndef MIN_VERSION_tetrishaskkkk
#define MIN_VERSION_tetrishaskkkk(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tetrishaskkkk */
...
#define CURRENT_COMPONENT_ID "tetrishaskkkk-0.1.0.0-inplace-tetrishaskkkk"
